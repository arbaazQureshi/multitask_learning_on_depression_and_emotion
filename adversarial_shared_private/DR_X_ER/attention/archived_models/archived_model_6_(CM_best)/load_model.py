...
def load_DAIC_WOZ_model(location=None):
	...
	Y1 = CuDNNLSTM(120, name = 'private_DW_lstm_layer', return_sequences = True)(X)
	Y2 = CuDNNLSTM(120, name = 'shared_lstm_layer', return_sequences = True)(X)
	...
	Y = Dense(45, activation = 'relu', name = 'DW_hidden_layer_1')(F)
...
def load_CMU_MOSEI_model(location=None):
	...
	Y1 = CuDNNLSTM(120, name = 'private_CM_lstm_layer', return_sequences = True)(X)
	Y2 = CuDNNLSTM(120, name = 'shared_lstm_layer', return_sequences = True)(X)
	...
	Y = TimeDistributed(Dense(45, activation = 'relu'), name = 'CM_hidden_layer_1')(F)
