...
def load_DAIC_WOZ_model(location=None):
	...
	Y1 = CuDNNLSTM(140, name = 'private_DW_lstm_layer', return_sequences = True)(X)
	Y2 = CuDNNLSTM(140, name = 'shared_lstm_layer', return_sequences = True)(X)
	...
	H = Dense(65, activation = 'tanh', name = 'DW_attention_hidden_layer_1')(H)
	...
	Y = Dense(55, activation = 'relu', name = 'DW_hidden_layer_1')(F)
	...
	Y_discriminator_output = Dense(50, activation = 'relu', name = 'shared_discriminator_hidden_layer_1')(Y_discriminator_input)
...
def load_CMU_MOSEI_model(location=None):
	...
	Y1 = CuDNNLSTM(140, name = 'private_CM_lstm_layer', return_sequences = True)(X)
	Y2 = CuDNNLSTM(140, name = 'shared_lstm_layer', return_sequences = True)(X)
	...
	H = TimeDistributed(Dense(65, activation = 'tanh'), name = 'CM_attention_hidden_layer_1')(H)
	...
	Y = TimeDistributed(Dense(55, activation = 'relu'), name = 'CM_hidden_layer_1')(F)
