...
def load_DAIC_WOZ_model(location=None):
	...
	Y1 = CuDNNLSTM(200, name = 'private_DW_lstm_layer', return_sequences = True)(X)
	Y2 = CuDNNLSTM(200, name = 'shared_lstm_layer', return_sequences = True)(X)
	...
	Y = Dense(120, activation = 'relu', name = 'DW_hidden_layer_1')(Y)
...
def load_CMU_MOSEI_model(location=None):
	...
	Y1 = CuDNNLSTM(200, name = 'private_CM_lstm_layer', return_sequences = True)(X)
	Y2 = CuDNNLSTM(200, name = 'shared_lstm_layer', return_sequences = True)(X)

	Y = Concatenate(axis = -1)([Y1, Y2])

	Y = TimeDistributed(Dense(120, activation = 'relu', name = 'CM_hidden_layer_1'))(Y)
